...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 SHIBA = IBEP20(0xfd1Ed27d3dD2eaE3172384612AA7a68604397759);
    ...
    uint256 public minimumTokenBalanceForDividends = 10000000000 * (10**9); // user must hold 10000000 token
    ...
    constructor() {
        router = IDEXRouter(0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73);
        _token = msg.sender;
    }
...
contract SHIBAX is
    BASEToken("Shiba God", "SHIBAX", 100000000000000,8)
{
    using SafeMath for uint256;
